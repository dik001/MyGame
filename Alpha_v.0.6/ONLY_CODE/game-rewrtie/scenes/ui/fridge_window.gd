...
const FRESHNESS_DISPLAY_MULTIPLIER: float = FoodFreshness.FRIDGE_SPOILAGE_MULTIPLIER

@onready var overlay: Control = $Overlay
@onready var freshness_header_label: Label = $Overlay/CenterContainer/PanelContainer/MarginContainer/Content/HeaderPanel/HeaderRow/FreshnessHeader
...
func _refresh_view() -> void:
	...
	for slot_index in range(_slots.size()):
		...
		row.bind_row(slot_index, slot_data, FRESHNESS_DISPLAY_MULTIPLIER)
