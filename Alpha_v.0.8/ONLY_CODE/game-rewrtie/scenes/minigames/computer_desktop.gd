...
@onready var shop_window: ShopWindow = $DesktopRoot/FullscreenAppLayer/AppHost/ShopWindow as ShopWindow
...
func _ready() -> void:
	...
	if shop_window != null:
		shop_window.payment_source = "bank"
		shop_window.use_delivery = true
...
func _change_scene_to_file_safe(scene_path: String) -> bool:
	...
	if scene_path == GAME_SCENE_PATH and GameManager != null and GameManager.has_method("queue_runtime_world_restore"):
		GameManager.queue_runtime_world_restore()
