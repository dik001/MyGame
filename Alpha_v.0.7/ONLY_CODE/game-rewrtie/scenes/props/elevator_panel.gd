...
@export var apartment_floor_target_portal_id: StringName = &"hall_elevator"
@export_file("*.tscn") var street_scene: String = DEFAULT_STREET_SCENE
@export var street_target_portal_id: StringName = &"town_building"
...
func _on_apartment_floor_pressed() -> void:
	_request_transition(apartment_floor_scene, apartment_floor_target_portal_id)


func _on_street_pressed() -> void:
	_request_transition(street_scene, street_target_portal_id)


func _request_transition(scene_path: String, target_portal_id: StringName) -> void:
	_close_menu()
	var game_manager := _get_game_manager()

	if game_manager == null:
		push_warning("ElevatorPanel could not find GameManager.")
		return

	game_manager.change_scene(scene_path, target_portal_id)
