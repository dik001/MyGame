...
const NOT_EDIBLE_TEXT := "\u042d\u0442\u043e\u0442 \u043f\u0440\u0435\u0434\u043c\u0435\u0442 \u043d\u0435\u043b\u044c\u0437\u044f \u0441\u044a\u0435\u0441\u0442\u044c."
const SPOILED_FOOD_TEXT := "\u042d\u0442\u0430 \u0435\u0434\u0430 \u0438\u0441\u043f\u043e\u0440\u0447\u0435\u043d\u0430."
const ATE_ITEM_TEXT := "\u0412\u044b \u0441\u044a\u0435\u043b\u0438 %s."
...
func consume_item(slot_index: int) -> bool:
	...
	if not item_data.is_consumable:
		_show_status_message(NOT_EDIBLE_TEXT)
		return false

	if not slot.can_consume_safely():
		_show_status_message(SPOILED_FOOD_TEXT)
		return false
	...
	_suppress_window_refresh = false
	_update_active_window()
	_show_status_message(ATE_ITEM_TEXT % item_data.get_display_name())
	return true
